      ...
      <div className="section-container">
        <div className="mb-12 sm:mb-16">
          ...
          <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-serif font-bold tracking-tight leading-tight">
            <span className="text-black dark:text-foreground">My journey and </span>
            <span className="italic text-ink-gray dark:text-muted-foreground">passion for technology</span>
          </h2>
        </div>
